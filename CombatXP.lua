...
function CombatXP.onPlayerExperienceGained(event, unitTag, currentExp, maxExp, reason)
    ...
    if ( unitTag ~= 'player' ) then return end
       ...
       CHAT_SYSTEM:AddMessage(tostring(xp_gained) .. " experience gained!")
    ...
    if CombatXP.inCombat then 
        ...
        CombatXPIndicatorLabel:SetText(tostring("XP gained in last combat: +" .. tostring(CombatXP.gained_in_current_combat)))
